...
impl BtopTheme {
    ...
    // Accents
    pub const CPU_CYAN: Color32 = Color32::from_rgb(0, 240, 255);      // #00f0ff
    pub const GPU_GREEN: Color32 = Color32::from_rgb(16, 185, 129);    // #10b981
    pub const RAM_MAGENTA: Color32 = Color32::from_rgb(236, 72, 153);  // #ec4899
    pub const DISK_ORANGE: Color32 = Color32::from_rgb(245, 158, 11);   // #f59e0b
    pub const NET_BLUE: Color32 = Color32::from_rgb(99, 102, 241);     // #6366f1
    pub const PROC_RED: Color32 = Color32::from_rgb(239, 68, 68);      // #ef4444
    pub const PURPLE: Color32 = Color32::from_rgb(168, 85, 247);       // #a855f7
